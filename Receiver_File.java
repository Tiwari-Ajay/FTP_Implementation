...
import java.io.*;
class Receiver_File extends JFrame implements ActionListener
{
	JButton b1,b2,b3,b4;JFrame frame1;Cursor cur1,cur2;JTextField t1,t2;
	String ip;int port;
	  Receiver_File(String ip1,int port1){
		  ip=ip1;port=port1;
	    frame1=new JFrame();
		frame1.setVisible(true);
		frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame1.setBounds(100,100,700,500);
	    frame1.setTitle("Receiver File");
		...
		l2.setText("!! File Receiver !!");
		l2.setBounds(150,100,400,100);
		...
		l5.setText("Choose Location : ");
		l5.setBounds(20,220,320,50);
		l5.setFont(f2);
		l5.setForeground(Color.BLUE);
		c.add(l5); //end l5
		 JLabel l6= new JLabel(); // l6 to file name label
		l6.setText("Enter File Name : ");
		l6.setBounds(20,300,280,50);
		l6.setFont(f2);
		l6.setForeground(Color.BLUE);
		c.add(l6); //end l6
		 t1=new JTextField();   // t1 (start)JTextField FOR FILE NAME
        t1.setBounds(280,305,400,40); 
		t1.setBackground(Color.WHITE);
		t1.setForeground(Color.BLUE);
		t1.setFont(f3);
         c.add(t1); 	// t1  end
		 b2=new JButton();  //File Chooser button creation
		b2.setText("Location Chooser");
		b2.setFont(f2);
		b2.setForeground(Color.BLUE);
		b2.setBackground(Color.CYAN);
		b2.setBounds(325,225,300,40);
		b2.setCursor(cur1);
     ...
     public void actionPerformed(ActionEvent e)
    {
	   ...
	   else if(e.getSource()==b3)
	   {
		   try{
		    ...
		    new FtpFileClient2(ip,port,file); 
		 }
		 catch(Exception e3)
		 {
	...
	{
		new Receiver_File("localhost",1990);
	}*/
