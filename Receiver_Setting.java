...
import java.io.*;
class Receiver_Setting extends JFrame implements ActionListener
{
	JButton b1,b2,b3,b4;JFrame frame1;Cursor cur1,cur2;JTextField t1,t2;
	  Receiver_Setting(){
	    ...
	    frame1.setTitle("Receiver Setting");
		...
		c.add(l4); //end l4
		 t2=new JTextField("1990");   // t2 (start) port number JTEXTFIELD
     ...
     public void actionPerformed(ActionEvent e)
    {
       ...
       else  if(e.getSource()==b2)
	   {
		   ...
		   String pot=t2.getText();
		   int port2=Integer.parseInt(pot);
		   new MessageClient(ip,port2);
		     frame1.dispose();
	   }
