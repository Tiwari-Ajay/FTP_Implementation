...
import java.io.*;
class Sender_Message extends JFrame implements ActionListener
{
	JButton b1,b2,b3,b4;JFrame frame1;Cursor cur1,cur2;JTextArea ta3;
	String ip;int port;
	  Sender_Message(String ip1,int port1){
		  ip=ip1;port=port1;
	    frame1=new JFrame();
		frame1.setVisible(true);
		frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame1.setBounds(100,100,700,500);
	    frame1.setTitle("Sender Message");
	...
	{
		new Sender_Message("localhost",7666);
	}
